	...
	<div class="span9">
		...
		<table class="table">
			<tr>
				...
				<th><?php echo $this->BootstrapPaginator->sort('firstname');?></th>
				<th><?php echo $this->BootstrapPaginator->sort('lastname');?></th>
				<th><?php echo $this->BootstrapPaginator->sort('userType');?></th>
