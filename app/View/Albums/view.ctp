        ...
        <div class="folders">
            ...
            <ul>
                ...
                <?php foreach ($folders as $folder): ?>
                    <li><?php echo $this->Html->link($folder[0], array('action' => 'view', $id, $folder[1])); ?></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
        ...
        <div class="span6">
            ...
            <div class="span6">
                <?php if (!empty($neighbors['prev'])): ?>
                    <?php echo $this->Html->link('Previous', array('action' => 'view', $neighbors['prev']['Upload']['album_id'], $neighbors['prev']['Upload']['folder'], '?' => array('imgid' => $neighbors['prev']['Upload']['id'])), array('class' => 'btn btn-primary neigh')); ?>
                <?php else: ?>
                    <div class="neigh btn btn-primary disabled">Previous</div>
                <?php endif; ?>
        ...
        <div class="span2 white">
            <div class="imgcontrols">
                ...
                <ul class="image-controls">
                    ...
                    <li>Contrast: <div id="slider6"></div></li>
                    <li>Invert: <div id="slider5"></div></li>
                    <li>Grayscale: <div id="slider-saturation"></div></li>
                </ul>
            </div>
        </div>
    <?php endif; ?>
